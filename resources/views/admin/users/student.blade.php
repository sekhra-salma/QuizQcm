...
@can('user_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
           <button class="btn btn-success" type="button"  data-toggle="modal" data-target="#createModal">
               Add Student
            </button>
              <!-- exel -->
    ...
    <div class="form-group">
     <table class="table">
      <tr>
       ...
       <td width="30">
        <input type="file" name="selectd_file" />
       </td>
      ...
      <tr>
       ...
       <td width="30"><span class="text-muted"> .xslx</span></td>
       <td width="30%" align="left"></td>
      </tr>
     </table>
     <center><a class="btn btn-warning" href="{{ route('admin.export') }}">Export User Data</a></center>
    </div>
   </form>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.user.fields.classe') }}
                        </th>
                      <!--  <th>
                            &nbsp;
                        </th>-->
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('roles') ? 'is-invalid' : '' }}" name="roles[]" id="roles" multiple required>
                    @foreach($roles as $id => $roles)
                        <option value="{{ $roles->id }}" {{ in_array($id, old('roles', [])) ? 'selected' : '' }}>{{ $roles->title }}</option>
                    @endforeach
                </select>
                @if($errors->has('roles'))
                    <div class="invalid-feedback">
